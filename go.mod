...
replace (
	github.com/kubewharf/katalyst-api => github.com/waynepeking348/katalyst-api v0.0.0-20230424031208-6417d83bd935
	...
	k8s.io/kubelet => github.com/kubewharf/kubelet v1.24.6-kubewharf.4
